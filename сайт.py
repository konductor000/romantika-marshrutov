...
.ярлык{
  font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
  font-size:15px;font-weight:600;color:var(--текст);margin-bottom:2px;
}
.ярлык span{font-weight:400;color:var(--бледный)}
...
(function(){
  ...
  if((СЕЗОН.daily||{}).kind==="tzolkin"){
    части.push('<div class="ярлык">Предсказание на день '
               +"<span>· по календарю майя</span></div>");
