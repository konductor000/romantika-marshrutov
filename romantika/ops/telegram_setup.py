...
SHORT_DESCRIPTION = "Клуб «Романтика маршрутов»: страна на сезон, задания недели, паспорт со штампами и журнал."
DESCRIPTION = (
    "Раз в три месяца рандомайзер выбирает страну, и мы разбираем её до мелочей. "
    "Каждый понедельник — задание: минимум на пять минут и максимум на вечер. "
    "Присылай сюда текст или фото — получишь штамп в паспорт сезона. Нажми «Начать»."
)
COMMANDS = [
    ("start", "Начать"),
    ("task", "Задание недели"),
